  ...
  const quickCards = [
    {
      ...
      description:
        "Subject-wise verified lecture notes uploaded directly by core faculty and expert seniors.",
      icon: BookOpen,
      href: "/notes",
      badge: "Notes Archive",
      hue: {
        ...
        leftBorder:
          "border-l-[3px] border-l-[#0066CC]/30 hover:border-l-[#0066CC]",
      },
    },
    {
      ...
      description:
        "Access structured mid-semester and end-semester question papers to decode examination patterns.",
      icon: FileText,
      href: "/pyqs",
      badge: "Exam Papers",
      hue: {
        ...
        leftBorder:
          "border-l-[3px] border-l-[#C25400]/30 hover:border-l-[#C25400]",
      },
    },
    {
      ...
      description:
        "Track complete roadmap checkpoints mapped explicitly for your active branch and academic term.",
      icon: Compass,
      href: "/roadmap",
      ...
      hue: {
        ...
        leftBorder:
          "border-l-[3px] border-l-[#15803D]/30 hover:border-l-[#15803D]",
      },
    },
    {
      title: "Announcements",
      subtitle:
        unreadCount > 0
          ? `${unreadCount} Actionable Bulletins`
          : "Zero Pending Actions",
      description:
        "Stay fully synchronized with crucial academic calendar directives and official institution despatches.",
      icon: Bell,
      href: "/announcements",
      badge: "Notice Board",
      hue: {
        ...
        leftBorder:
          "border-l-[3px] border-l-[#6E56CF]/30 hover:border-l-[#6E56CF]",
      },
    },
  ];
    ...
    <div className="max-w-6xl mx-auto space-y-12 pb-16 font-sans text-[#37352F] selection:bg-[#EAEAEA]">
      ...
      <div className="border-b border-[#EAEAEA] pb-8 pt-2 space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs sm:text-sm text-[#787774] tracking-wide max-w-2xl leading-relaxed">
            Access your highly curated study content, explore continuous
            university archives, and complete localized academic roadmap
            objectives.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 pt-2 text-xs">
          <div className="flex items-center gap-1.5 bg-[#EBF5FF] text-[#0066CC] px-2.5 py-1 rounded-[4px] border border-[#D6EBF2]">
            ...
            <span className="text-[10px] uppercase tracking-widest font-mono text-[#0066CC]/80">
              Branch:
            </span>
          ...
          <div className="flex items-center gap-1.5 bg-[#FFF5EB] text-[#C25400] px-2.5 py-1 rounded-[4px] border border-[#FFE1CC]">
            ...
            <span className="text-[10px] uppercase tracking-widest font-mono text-[#C25400]/80">
              Term:
            </span>
            <span className="font-semibold font-mono">
          ...
          <div className="flex items-center gap-1.5 bg-[#EDFDF4] text-[#15803D] px-2.5 py-1 rounded-[4px] border border-[#DCFCE7]">
            ...
            <span className="text-[10px] uppercase tracking-widest font-mono text-[#15803D]/80">
              Access:
            </span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-[#EAEAEA] border-l-[3px] border-l-[#C25400]/30 hover:border-l-[#C25400] rounded-[4px] p-6 flex flex-col justify-between space-y-4 transition-all duration-200 hover:border-[#787774]">
          ...
          <div>
            <div className="text-3xl font-light tracking-tight text-[#37352F]">
              5{" "}
              <span className="text-xs font-normal text-[#C25400] tracking-wide uppercase ml-1 font-mono font-medium">
                Days
              </span>
            </div>
          ...
          <div className="pt-3 border-t border-[#EAEAEA] flex items-center justify-between text-[11px] text-[#787774]">
            <span className="flex items-center gap-1">
              <Clock className="w-3 h-3 stroke-[1.5]" /> Verified rhythm
            </span>
        ...
        <div className="bg-white border border-[#EAEAEA] border-l-[3px] border-l-[#0066CC]/30 hover:border-l-[#0066CC] rounded-[4px] p-6 flex flex-col justify-between space-y-4 transition-all duration-200 hover:border-[#787774]">
          ...
          <div>
            <div className="text-3xl font-light tracking-tight text-[#37352F]">
              {unreadCount}{" "}
              <span className="text-xs font-normal text-[#0066CC] tracking-wide uppercase ml-1 font-mono font-medium">
                Unread
              </span>
            </div>
            <p className="text-xs text-[#787774] mt-1 tracking-wide">
              {unreadCount > 0
                ? "Pending directives require review."
                : "All core communications reviewed."}
            </p>
          </div>
          <Link
            href="/announcements"
            className="pt-3 border-t border-[#EAEAEA] flex items-center justify-between text-[11px] text-[#37352F] hover:text-[#0066CC] hover:underline font-medium transition-colors"
          >
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between border-b border-[#EAEAEA] pb-3">
          ...
          <Link
            href="/announcements"
            className="text-xs text-[#37352F] hover:underline tracking-wide flex items-center gap-1 font-medium"
          >
        ...
        {(pinnedAnnouncements ?? []).length > 0 ? (
          ...
          <div className="bg-white border border-[#EAEAEA] rounded-[4px] p-8 text-center space-y-2">
            <p className="text-xs font-medium text-[#37352F]">
              No priority dispatches listed
            </p>
            <p className="text-xs text-[#787774] max-w-md mx-auto">
              The active critical circular queue is clear. Standard documents
              remain completely accessible under the main institutional index.
            </p>
          </div>
        )}
      </section>
          ...
          {quickCards.map((card) => (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div
                  className={`flex h-10 w-10 items-center justify-center rounded-[4px] ${card.hue.bg} border ${card.hue.border} ${card.hue.text} transition-colors duration-200 shrink-0`}
                >
                  <card.icon className="h-4 w-4 stroke-[1.5]" />
                </div>
                <span
                  className={`text-[10px] font-mono tracking-wider uppercase border ${card.hue.border} ${card.hue.bg} ${card.hue.text} px-2.5 py-0.5 rounded-[4px] font-medium`}
                >
                  {card.badge}
                </span>
              </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-xs text-[#787774] tracking-wide max-w-xl leading-relaxed pt-1">
                Completed {roadmapDone} of {roadmapTotal} verified roadmap
                deliverables mapped for current term evaluation.
              </p>
            </div>

            <div className="flex items-center gap-4 shrink-0">
              <div className="text-right">
                <div className="text-xl font-mono font-semibold text-[#15803D]">
                  {roadmapPct}%
                </div>
                <div className="text-[10px] font-mono text-[#787774] uppercase tracking-widest">
                  Index Status
                </div>
              </div>
              <Link
