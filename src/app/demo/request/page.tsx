  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10 space-y-8 pb-16">
      ...
      {submittedSuccess ? (
        ...
        <div className="rounded-3xl bg-card border border-border p-8 sm:p-12 shadow-md relative overflow-hidden text-center max-w-2xl mx-auto space-y-6">
          ...
          <div className="mx-auto w-20 h-20 rounded-full bg-emerald-500/10 dark:bg-emerald-400/10 flex items-center justify-center border border-emerald-500/25 dark:border-emerald-400/25 relative">
            <div className="absolute inset-0 rounded-full bg-emerald-500/10 animate-ping opacity-75 animate-duration-1000" />
          ...
          <div className="pt-2">
            <Button
              ...
              size="lg"
              onClick={handleReset}
              className="rounded-xl px-8 font-bold border-emerald-500/20 hover:bg-emerald-500/5 cursor-pointer text-xs h-10"
            >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              <div className="space-y-3">
                <Label className="text-xs font-bold text-muted-foreground uppercase tracking-widest select-none">
                ...
                {type === "REQUEST" ? (
                  <div className="space-y-2">
                    <Label
                      ...
                      className="text-xs font-bold text-muted-foreground uppercase tracking-widest select-none"
                    >
                      Subject Name
                    </Label>
                    <Input
                    ...
                    />
                    <p className="text-[11px] text-muted-foreground/80 font-medium select-none">
          ...
          <div className="space-y-6">
            <div className="rounded-3xl bg-card border border-border p-6 shadow-sm relative overflow-hidden flex flex-col justify-between h-full min-h-[300px]">
              ...
              <div className="space-y-4">
                ...
                <h3 className="text-base font-black text-foreground select-none">
              ...
              <div className="pt-6 border-t border-border/60 text-[10px] text-muted-foreground/60 leading-normal font-mono flex items-center gap-1.5 select-none">
